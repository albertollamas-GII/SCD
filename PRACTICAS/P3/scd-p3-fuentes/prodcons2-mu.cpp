/**
 * @file prodcons2-mu.cpp
 * @author Alberto Llamas 
 * @brief Productores consumidores con multiples productores y multiples consumidores
 * @version 0.1
 * @date 2022-11-29
 * 
...
/*
    Cada productor hace num_items/np iteraciones
    Cada consumidor hace num_items/nc iteraciones
    Argumento mas en funcion_productor y funcion_consumidor que es el numero de orden
    num_orden 
    Reparto por bloques
*/
...
// en orden arbitrario
// (versión con multiples productores y multiples consumidores)
// -----------------------------------------------------------------------------
// mpicxx -std=c++11 -g -Wall -o prodcons2_muu.exe prodcons2-mu.cpp
// mpirun -oversubscribe -np 10 ./prodcons2_muu.exe
...
#define ETIQ_PRODUCTOR 1
#define ETIQ_CONSUMIDOR 2

const int
   num_productores       = 4 ,
   num_consumidores      = 5 ,
   id_buffer             = num_productores , //identificador del buffer
   num_procesos_esperado = num_productores + num_consumidores + 1 , //numero total de procesos esperado
   num_items             = num_productores*num_consumidores, //numero de datos producidos/consumidos
   tam_vector            = 10;
...
// ---------------------------------------------------------------------
//Espera selectiva en MPI (comportamiento del buffer)
void funcion_buffer()
{
