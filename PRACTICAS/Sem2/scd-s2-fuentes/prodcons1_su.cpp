...
//Realizado por Alberto Llamas Gonzalez
...
void funcion_hebra_productora_LIFO( MRef<ProdConsSU_LIFO> monitor )
{
   for( unsigned i = 0 ; i < num_items ; i++ )
   {
...
void funcion_hebra_consumidora_LIFO( MRef<ProdConsSU_LIFO>  monitor )
{
   for( unsigned i = 0 ; i < num_items ; i++ )
   {
...
void funcion_hebra_productora_FIFO( MRef<ProdConsSU_FIFO> monitor )
{
   for( unsigned i = 0 ; i < num_items ; i++ )
   {
      int valor = producir_dato(  ) ;
...
void funcion_hebra_consumidora_FIFO( MRef<ProdConsSU_FIFO>  monitor )
{
   for( unsigned i = 0 ; i < num_items ; i++ )
   {
      int valor = monitor->leer();
...
{
   cout << "--------------------------------------------------------------------" << endl
        << "Problema del productor-consumidor únicos (Monitor SU, buffer LIFO o FIFO). " << endl
        << "--------------------------------------------------------------------" << endl
        << flush ;
   ...
   thread hebra_prod( funcion_hebra_productora_FIFO, monitor ),
          hebra_cons( funcion_hebra_consumidora_FIFO, monitor );
